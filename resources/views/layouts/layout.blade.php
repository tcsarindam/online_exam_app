...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('admin') }}" class="brand-link">
      <img src="{{ url('public/assets/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Online Exam App</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <!--<div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">BK ADMIN</a>
        </div>
      </div>-->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('admin') }}" class="nav-link <?php if($page_name == 'dashboard') echo 'active';  ?>">
          ...
          <li class="nav-item">
            <a href="{{ url('admin/exam_category') }}" class="nav-link <?php if($page_name == 'exam_category') echo 'active';  ?>">
          ...
          <li class="nav-item">
            <a href="{{ url('admin/manage_exam') }}" class="nav-link <?php if($page_name == 'manage_exam') echo 'active';  ?>">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Manage Exams
               <!-- <span class="right badge badge-danger">Category</span>-->
          ...
          <li class="nav-item">
            <a href="{{ url('admin/manage_students') }}" class="nav-link <?php if($page_name == 'manage_students') echo 'active';  ?>">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Manage Students
               <!-- <span class="right badge badge-danger">Category</span>-->
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('admin/all_student_results') }}" class="nav-link <?php if($page_name == 'all_student_results') echo 'active';  ?>">
                  <p>All Rsults</p>
                </a>
              </li>
              <!--<li class="nav-item">
                <a href="{{ url('admin/search_result') }}" class="nav-link">
                  <p>Search Result</p>
                </a>
              </li>-->
            </ul>
          ...
          <li class="nav-item">
            <a href="{{ url('admin/manage_portal') }}" class="nav-link <?php if($page_name == 'manage_portal') echo 'active';  ?>">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Manage Portal
               <!-- <span class="right badge badge-danger">Category</span>-->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021-2022 <a href="http://bluekrystaltecsol.com">Blue Krystal Technologies</a>.</strong>
    All rights reserved.
