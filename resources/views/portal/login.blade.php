...
<html>
<head>
	<title>Online Exam App|Portal-Login</title>
	<meta charset="utf-8">
	...
	<div class="container">
		<div class="signup_container">	
			...
			<div class="signup_title">
				...
				<span><font style="font-size: 1.2em; font-weight: bold;">Portal Login</font></span>
		...
		<form action="{{ url('portal/login_sub') }}"  class="database_operation">
			<div class="signup_form">
				<div class="row">
					...
					<div class="col-sm-12">
						<h5 class="text-center">Don't Have An Account? <a href="{{ url('portal/signup') }}" class="btn btn-primary btn-block">Sign Up</a></h5>
					</div>						
				</div>
			</div>
		</form>
